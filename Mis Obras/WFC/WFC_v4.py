...
def colapsoEnPropagacion(cuadricula,casilla,tile,casillasAdyacentes,markovTile,tiles):
    num = random.randint(1,10)
    if num >=5:
        cuadricula[casilla[0]][casilla[1]][0] = tile
    ...
    for casilla in casillasAdyacentes:
        ...
        for opcion in markovTile:
            ...
            if opcion == 0 and elemento in cuadricula[casilla[0]][casilla[1]][1]:
                cuadricula[casilla[0]][casilla[1]][1].remove(elemento)
            cont+=1
        colapsoEnPropagacion(cuadricula,casilla,tile,casillasAdyacentes,markovTile,tiles)
