...
while True:
    time.sleep(0.1)  # ralentiza para que se vea el proceso
    ...
    '''   # Actualizamos la imagen tras cada colapso
    for i in range(height):
        for j in range(width):
            ...
            if tile in colores:
                ...
                imagen[i, j] = (255, 255, 255)  # blanco para casillas sin colapsar

   plt.imshow(imagen)
    plt.axis('off')
    plt.draw()
    plt.pause(0.01)  # muestra la imagen de forma interactiva'''
